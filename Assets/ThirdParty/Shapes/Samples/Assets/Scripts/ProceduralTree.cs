...
namespace Shapes
{
    ...
    public class ProceduralTree : ImmediateModeShapeDrawer
    {
        ...
        [Range(0, 1)]
        public float branchLengthMax = 1;
        [Range(0, ShapesMath.TAU / 2)]
        public float maxAngDeviation = ShapesMath.TAU / 6;
        ...
        // Draws a line, moves forward, and then queues up new positions to draw from per new branch
