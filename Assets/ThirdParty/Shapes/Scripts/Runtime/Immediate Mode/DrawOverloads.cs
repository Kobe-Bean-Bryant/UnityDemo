...
namespace Shapes
{
    public static partial class Draw
    {
        ...
        public static void Line(Vector3 start, Vector3 end, float thickness, LineEndCap endCaps, Color colorStart,
            Color colorEnd) => Line_Internal(endCaps, ThicknessSpace, start, end, colorStart, colorEnd, thickness);
        ...
        [MethodImpl(INLINE)]
        public static void Polyline(PolylinePath path) => Polyline_Internal(path, false, PolylineGeometry,
            PolylineJoins, Thickness, ThicknessSpace, Color);
        ...
        [MethodImpl(INLINE)]
        public static void Polyline(PolylinePath path, bool closed) => Polyline_Internal(path, closed, PolylineGeometry,
            PolylineJoins, Thickness, ThicknessSpace, Color);
        ...
        [MethodImpl(INLINE)]
        public static void Polyline(PolylinePath path, float thickness) => Polyline_Internal(path, false,
            PolylineGeometry, PolylineJoins, thickness, ThicknessSpace, Color);
        ...
        [MethodImpl(INLINE)]
        public static void Polyline(PolylinePath path, bool closed, float thickness) => Polyline_Internal(path, closed,
            PolylineGeometry, PolylineJoins, thickness, ThicknessSpace, Color);
        ...
        [MethodImpl(INLINE)]
        public static void Polyline(PolylinePath path, Color color) => Polyline_Internal(path, false, PolylineGeometry,
            PolylineJoins, Thickness, ThicknessSpace, color);
        ...
        [MethodImpl(INLINE)]
        public static void Polyline(PolylinePath path, bool closed, Color color) => Polyline_Internal(path, closed,
            PolylineGeometry, PolylineJoins, Thickness, ThicknessSpace, color);
        ...
        [MethodImpl(INLINE)]
        public static void Polyline(PolylinePath path, float thickness, Color color) => Polyline_Internal(path, false,
            PolylineGeometry, PolylineJoins, thickness, ThicknessSpace, color);
        ...
        [MethodImpl(INLINE)]
        public static void
            Polyline(PolylinePath path, bool closed, float thickness, PolylineJoins joins, Color color) =>
            Polyline_Internal(path, closed, PolylineGeometry, joins, thickness, ThicknessSpace, color);
        ...
        [MethodImpl(INLINE)]
        public static void Polygon(PolygonPath path) => Polygon_Internal(path, PolygonTriangulation, Color);
        ...
        [MethodImpl(INLINE)]
        public static void
            RegularPolygonBorder(int sideCount, float radius, float thickness, float angle, Color color) =>
            RegularPolygon_Internal(sideCount, radius, thickness, color, true, 0f, angle);

        /// <summary>Draws a regular polygon</summary><param name="sideCount">Number of sides of this regular polygon. 3 = triangle, 5 = pentagon, 6 = hexagon, and so on!</param><param name="radius">The radius from center to vertex</param><param name="thickness">The thickness of the border</param><param name="angle">Angular offset in radians</param><param name="roundness">A value from 0 to 1 setting how rounded the corners should be. 0 means sharp, 1 means fully rounded</param>
        [MethodImpl(INLINE)]
        public static void RegularPolygonBorder(int sideCount, float radius, float thickness, float angle,
            float roundness) => RegularPolygon_Internal(sideCount, radius, thickness, Color, true, roundness, angle);
        ...
        [MethodImpl(INLINE)]
        public static void Disc() => Disc_Internal(Radius, Color);
        ...
        [MethodImpl(INLINE)]
        public static void Disc(DiscColors colors) => Disc_Internal(Radius, colors);

        /// <summary>Draws a solid filled disc</summary><param name="radius">The radius of this disc</param>
        [MethodImpl(INLINE)]
        public static void Disc(float radius) => Disc_Internal(radius, Color);
        ...
        [MethodImpl(INLINE)]
        public static void Disc(float radius, DiscColors colors) => Disc_Internal(radius, colors);
        ...
        [MethodImpl(INLINE)]
        public static void Ring() => Ring_Internal(Radius, Thickness, Color);
        ...
        [MethodImpl(INLINE)]
        public static void Ring(DiscColors colors) => Ring_Internal(Radius, Thickness, colors);

        /// <summary>Draws a ring (circle)</summary><param name="radius">The radius of this ring</param>
        [MethodImpl(INLINE)]
        public static void Ring(float radius) => Ring_Internal(radius, Thickness, Color);
        ...
        [MethodImpl(INLINE)]
        public static void Ring(float radius, DiscColors colors) => Ring_Internal(radius, Thickness, colors);
        ...
        [MethodImpl(INLINE)]
        public static void Ring(float radius, float thickness) => Ring_Internal(radius, thickness, Color);
        ...
        [MethodImpl(INLINE)]
        public static void Arc(float radius, float angleRadStart, float angleRadEnd, ArcEndCap endCaps,
            DiscColors colors) => Arc_Internal(radius, Thickness, colors, angleRadStart, angleRadEnd, endCaps);
        ...
        [MethodImpl(INLINE)]
        public static void
            Arc(float radius, float thickness, float angleRadStart, float angleRadEnd, DiscColors colors) =>
            Arc_Internal(radius, thickness, colors, angleRadStart, angleRadEnd, ArcEndCap.None);
        ...
        [MethodImpl(INLINE)]
        public static void
            Arc(float radius, float thickness, float angleRadStart, float angleRadEnd, ArcEndCap endCaps) =>
            Arc_Internal(radius, thickness, Color, angleRadStart, angleRadEnd, endCaps);
        ...
        [MethodImpl(INLINE)]
        public static void Rectangle(Rect rect, float cornerRadius) => Rectangle_Internal(BlendMode, false, rect, Color,
            Thickness, new Vector4(cornerRadius, cornerRadius, cornerRadius, cornerRadius));
        ...
        [MethodImpl(INLINE)]
        public static void Rectangle(Rect rect, float cornerRadius, Color color) => Rectangle_Internal(BlendMode, false,
            rect, color, Thickness, new Vector4(cornerRadius, cornerRadius, cornerRadius, cornerRadius));
        ...
        [MethodImpl(INLINE)]
        public static void RectangleBorder(Rect rect, float thickness, float cornerRadius) => Rectangle_Internal(
            BlendMode, true, rect, Color, thickness,
            new Vector4(cornerRadius, cornerRadius, cornerRadius, cornerRadius));
        ...
        public static void Triangle(Vector3 a, Vector3 b, Vector3 c, float roundness, Color colorA, Color colorB,
            Color colorC) => Triangle_Internal(a, b, c, false, Thickness, roundness, colorA, colorB, colorC);
        ...
        public static void TriangleBorder(Vector3 a, Vector3 b, Vector3 c, float thickness, Color colorA, Color colorB,
            Color colorC) => Triangle_Internal(a, b, c, true, thickness, 0f, colorA, colorB, colorC);
        ...
        [MethodImpl(INLINE)]
        public static void TriangleBorder(Vector3 a, Vector3 b, Vector3 c, float thickness, float roundness,
            Color color) => Triangle_Internal(a, b, c, true, thickness, roundness, color, color, color);
        ...
        [MethodImpl(INLINE)]
        public static void
            Quad(Vector3 a, Vector3 b, Vector3 c, Color colorA, Color colorB, Color colorC, Color colorD) =>
        ...
        public static void Quad(Vector3 a, Vector3 b, Vector3 c, Vector3 d, Color colorA, Color colorB, Color colorC,
            Color colorD) => Quad_Internal(a, b, c, d, colorA, colorB, colorC, colorD);
        ...
        [MethodImpl(INLINE)]
        public static void Sphere() => Sphere_Internal(Radius, Color);
        ...
        [MethodImpl(INLINE)]
        public static void Sphere(Color color) => Sphere_Internal(Radius, color);
        ...
        [MethodImpl(INLINE)]
        public static void Text(TextElement element, TextAlign align) => Text_Internal(false, null, element, default,
            default, Font, FontSize, align, Color);
        ...
        [MethodImpl(INLINE)]
        public static void Text(TextElement element, float fontSize) => Text_Internal(false, null, element, default,
            default, Font, fontSize, TextAlign, Color);
        ...
        [MethodImpl(INLINE)]
        public static void Text(TextElement element, TMP_FontAsset font) => Text_Internal(false, null, element, default,
            default, font, FontSize, TextAlign, Color);
        ...
        [MethodImpl(INLINE)]
        public static void Text(TextElement element, Color color) => Text_Internal(false, null, element, default,
            default, Font, FontSize, TextAlign, color);
        ...
        [MethodImpl(INLINE)]
        public static void Text(TextElement element, float fontSize, Color color) => Text_Internal(false, null, element,
            default, default, Font, fontSize, TextAlign, color);
        ...
        [MethodImpl(INLINE)]
        public static void Text(TextElement element, TMP_FontAsset font, Color color) => Text_Internal(false, null,
            element, default, default, font, FontSize, TextAlign, color);
        ...
        [MethodImpl(INLINE)]
        public static void
            Text(TextElement element, TextAlign align, float fontSize, TMP_FontAsset font, Color color) =>
            Text_Internal(false, null, element, default, default, font, fontSize, align, color);
        ...
        [MethodImpl(INLINE)]
        public static void Text(TextElement element, string content) => Text_Internal(false, content, element, default,
            default, Font, FontSize, TextAlign, Color);
        ...
        [MethodImpl(INLINE)]
        public static void Text(TextElement element, string content, float fontSize) => Text_Internal(false, content,
            element, default, default, Font, fontSize, TextAlign, Color);
        ...
        [MethodImpl(INLINE)]
        public static void Text(TextElement element, string content, TMP_FontAsset font) => Text_Internal(false,
            content, element, default, default, font, FontSize, TextAlign, Color);
        ...
        [MethodImpl(INLINE)]
        public static void Text(TextElement element, string content, Color color) => Text_Internal(false, content,
            element, default, default, Font, FontSize, TextAlign, color);
        ...
        [MethodImpl(INLINE)]
        public static void
            Text(TextElement element, string content, TextAlign align, TMP_FontAsset font, Color color) =>
            Text_Internal(false, content, element, default, default, font, FontSize, align, color);
        ...
        [MethodImpl(INLINE)]
        public static void Text(string content, float fontSize) => Text_Internal(false, content, null, default, default,
            Font, fontSize, TextAlign, Color);
        ...
        [MethodImpl(INLINE)]
        public static void Text(string content, TMP_FontAsset font) => Text_Internal(false, content, null, default,
            default, font, FontSize, TextAlign, Color);
        ...
        [MethodImpl(INLINE)]
        public static void Text(string content, float fontSize, TMP_FontAsset font) => Text_Internal(false, content,
            null, default, default, font, fontSize, TextAlign, Color);
        ...
        [MethodImpl(INLINE)]
        public static void Text(string content, Color color) => Text_Internal(false, content, null, default, default,
            Font, FontSize, TextAlign, color);
        ...
        [MethodImpl(INLINE)]
        public static void Text(string content, float fontSize, Color color) => Text_Internal(false, content, null,
            default, default, Font, fontSize, TextAlign, color);
        ...
        [MethodImpl(INLINE)]
        public static void Text(string content, TMP_FontAsset font, Color color) => Text_Internal(false, content, null,
            default, default, font, FontSize, TextAlign, color);
        ...
        [MethodImpl(INLINE)]
        public static void
            TextRect(TextElement element, Vector2 pivot, Vector2 size, TextAlign align, float fontSize) =>
            Text_Internal(true, null, element, pivot, size, Font, fontSize, align, Color);
        ...
        [MethodImpl(INLINE)]
        public static void TextRect(TextElement element, Vector2 pivot, Vector2 size, TextAlign align,
            TMP_FontAsset font) => Text_Internal(true, null, element, pivot, size, font, FontSize, align, Color);

        /// <summary>Draws text using Text Mesh Pro</summary><param name="element">The text element to use when drawing this text</param><param name="pivot">The normalized pivot of the local space rectangle for text positioning, like Unity's RectTransform</param><param name="size">The local space size of the rectangle to draw text the in</param><param name="fontSize">The text alignment to use</param><param name="font">The font to use</param>
        [MethodImpl(INLINE)]
        public static void TextRect(TextElement element, Vector2 pivot, Vector2 size, float fontSize,
            TMP_FontAsset font) => Text_Internal(true, null, element, pivot, size, font, fontSize, TextAlign, Color);
        ...
        [MethodImpl(INLINE)]
        public static void TextRect(TextElement element, Vector2 pivot, Vector2 size, TextAlign align, float fontSize,
            Color color) => Text_Internal(true, null, element, pivot, size, Font, fontSize, align, color);
        ...
        [MethodImpl(INLINE)]
        public static void
            TextRect(TextElement element, Vector2 pivot, Vector2 size, TMP_FontAsset font, Color color) =>
            Text_Internal(true, null, element, pivot, size, font, FontSize, TextAlign, color);
        ...
        [MethodImpl(INLINE)]
        public static void
            TextRect(TextElement element, Vector2 pivot, Vector2 size, string content, TextAlign align) =>
            Text_Internal(true, content, element, pivot, size, Font, FontSize, align, Color);
        ...
        public static void TextRect(TextElement element, Vector2 pivot, Vector2 size, string content, TextAlign align,
            float fontSize) => Text_Internal(true, content, element, pivot, size, Font, fontSize, align, Color);

        /// <summary>Draws text using Text Mesh Pro</summary><param name="element">The text element to use when drawing this text</param><param name="pivot">The normalized pivot of the local space rectangle for text positioning, like Unity's RectTransform</param><param name="size">The local space size of the rectangle to draw text the in</param><param name="content">The text to display</param><param name="font">The font to use</param>
        [MethodImpl(INLINE)]
        public static void TextRect(TextElement element, Vector2 pivot, Vector2 size, string content,
            TMP_FontAsset font) => Text_Internal(true, content, element, pivot, size, font, FontSize, TextAlign, Color);

        /// <summary>Draws text using Text Mesh Pro</summary><param name="element">The text element to use when drawing this text</param><param name="pivot">The normalized pivot of the local space rectangle for text positioning, like Unity's RectTransform</param><param name="size">The local space size of the rectangle to draw text the in</param><param name="content">The text to display</param><param name="align">The text alignment to use</param><param name="font">The font to use</param>
        [MethodImpl(INLINE)]
        public static void TextRect(TextElement element, Vector2 pivot, Vector2 size, string content, TextAlign align,
            TMP_FontAsset font) => Text_Internal(true, content, element, pivot, size, font, FontSize, align, Color);
        ...
        [MethodImpl(INLINE)]
        public static void TextRect(TextElement element, Vector2 pivot, Vector2 size, string content, TextAlign align,
            Color color) => Text_Internal(true, content, element, pivot, size, Font, FontSize, align, color);

        /// <summary>Draws text using Text Mesh Pro</summary><param name="element">The text element to use when drawing this text</param><param name="pivot">The normalized pivot of the local space rectangle for text positioning, like Unity's RectTransform</param><param name="size">The local space size of the rectangle to draw text the in</param><param name="content">The text to display</param><param name="fontSize">The text alignment to use</param><param name="color">The color of the textrect</param>
        [MethodImpl(INLINE)]
        public static void TextRect(TextElement element, Vector2 pivot, Vector2 size, string content, float fontSize,
            Color color) => Text_Internal(true, content, element, pivot, size, Font, fontSize, TextAlign, color);
        ...
        [MethodImpl(INLINE)]
        public static void TextRect(Vector2 pivot, Vector2 size, string content, TextAlign align, float fontSize,
            TMP_FontAsset font) => Text_Internal(true, content, null, pivot, size, font, fontSize, align, Color);
        ...
        [MethodImpl(INLINE)]
        public static void TextRect(Vector2 pivot, Vector2 size, string content, TextAlign align, float fontSize,
            Color color) => Text_Internal(true, content, null, pivot, size, Font, fontSize, align, color);
        ...
        [MethodImpl(INLINE)]
        public static void TextRect(Vector2 pivot, Vector2 size, string content, float fontSize, TMP_FontAsset font,
            Color color) => Text_Internal(true, content, null, pivot, size, font, fontSize, TextAlign, color);
        ...
        [MethodImpl(INLINE)]
        public static void
            TextRect(TextElement element, Rect rect, TextAlign align, float fontSize, TMP_FontAsset font) =>
            TextRect_Internal(null, element, rect, font, fontSize, align, Color);
        ...
        public static void TextRect(TextElement element, Rect rect, TextAlign align, float fontSize, TMP_FontAsset font,
            Color color) => TextRect_Internal(null, element, rect, font, fontSize, align, color);
        ...
        [MethodImpl(INLINE)]
        public static void
            TextRect(TextElement element, Rect rect, string content, TextAlign align, TMP_FontAsset font) =>
            TextRect_Internal(content, element, rect, font, FontSize, align, Color);

        /// <summary>Draws text using Text Mesh Pro</summary><param name="element">The text element to use when drawing this text</param><param name="rect">The local space rectangle to display text within</param><param name="content">The text to display</param><param name="fontSize">The text alignment to use</param><param name="font">The font to use</param>
        [MethodImpl(INLINE)]
        public static void
            TextRect(TextElement element, Rect rect, string content, float fontSize, TMP_FontAsset font) =>
            TextRect_Internal(content, element, rect, font, fontSize, TextAlign, Color);

        /// <summary>Draws text using Text Mesh Pro</summary><param name="element">The text element to use when drawing this text</param><param name="rect">The local space rectangle to display text within</param><param name="content">The text to display</param><param name="align">The text alignment to use</param><param name="fontSize">The text alignment to use</param><param name="font">The font to use</param>
        [MethodImpl(INLINE)]
        public static void TextRect(TextElement element, Rect rect, string content, TextAlign align, float fontSize,
            TMP_FontAsset font) => TextRect_Internal(content, element, rect, font, fontSize, align, Color);
        ...
        [MethodImpl(INLINE)]
        public static void TextRect(TextElement element, Rect rect, string content, TextAlign align, float fontSize,
            Color color) => TextRect_Internal(content, element, rect, Font, fontSize, align, color);
        ...
        public static void TextRect(TextElement element, Rect rect, string content, float fontSize, TMP_FontAsset font,
            Color color) => TextRect_Internal(content, element, rect, font, fontSize, TextAlign, color);

        /// <summary>Draws text using Text Mesh Pro</summary><param name="element">The text element to use when drawing this text</param><param name="rect">The local space rectangle to display text within</param><param name="content">The text to display</param><param name="align">The text alignment to use</param><param name="fontSize">The text alignment to use</param><param name="font">The font to use</param><param name="color">The color of the textrect</param>
        [MethodImpl(INLINE)]
        public static void TextRect(TextElement element, Rect rect, string content, TextAlign align, float fontSize,
            TMP_FontAsset font, Color color) => TextRect_Internal(content, element, rect, font, fontSize, align, color);
        ...
        [MethodImpl(INLINE)]
        public static void TextRect(Rect rect, string content, TextAlign align, float fontSize, TMP_FontAsset font,
            Color color) => TextRect_Internal(content, null, rect, font, fontSize, align, color);
        ...
        [MethodImpl(INLINE)]
        public static void Texture(Texture texture, Rect rect, Rect uvs) => Texture_Internal(texture, rect, uvs, Color);
        ...
        [MethodImpl(INLINE)]
        public static void
            Texture(Texture texture, Vector2 center, float size, TextureSizeMode sizeMode, Color color) =>
            Texture_PosSize_Internal(texture, center, size, sizeMode, color);
    }
}
