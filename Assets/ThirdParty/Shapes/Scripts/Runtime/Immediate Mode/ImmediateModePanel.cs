...
namespace Shapes
{
    ...
    public class ImmediateModePanel : MonoBehaviour
    {
        ...
        ImmediateModeCanvas ImCanvas =>
            imCanvas != null ? imCanvas : (imCanvas = GetComponentInParent<ImmediateModeCanvas>());
        ...
        public virtual void OnEnable()
        {
            ...
            {
                Debug.LogWarning(
                    $"{nameof(ImmediateModePanel)} attached to {gameObject.name} is missing an {nameof(ImmediateModeCanvas)} component on its canvas",
                    this);
            }
        }
