...
namespace Shapes
{
    ...
    public class ImmediateModeCanvas : ImmediateModeShapeDrawer
    {
        ...
        RectTransform CanvasRectTf =>
            canvasRectTf = canvasRectTf != null ? canvasRectTf : GetComponent<RectTransform>();
        Camera camUI;
        ...
        protected void DrawPanels()
        {
            using (Draw.Scope)
            {
                ...
                {
#if UNITY_EDITOR
                    if (canvasContext.camera.cameraType is CameraType.SceneView &&
        ...
        public override void DrawShapes(Camera cam)
        {
            ...
            using (Draw.Command(cam))
            {
                ...
                canvasContext.UpdateParams(Canvas, cam, cnvTf,
                    DisplayAsWorldSpacePanel(cam) ? cnvTf.localToWorldMatrix : GetOverlayToWorldMatrix(cam));
        ...
        bool DisplayAsWorldSpacePanel(Camera cam) =>
            cam.cameraType == CameraType.SceneView || (IsCameraBasedUI && cam == Canvas.worldCamera);
